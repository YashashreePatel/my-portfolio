...
const Intro = () => {
  return (
    <div id='intro' className='w-full h-screen flex items-center justify-center'>
      <div className='px-[200px] flex flex-col gap-6 justify-center items-center'>
        <div className='font-inter font-medium text-[80px] text-grey-3 text-center leading-none tracking-[-0.025em]'>
