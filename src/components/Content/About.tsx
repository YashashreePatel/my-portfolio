...
const About = () => {
  ...
  return (
    <div id='about' className='w-3/5 flex flex-row gap-10 m-auto items-center justify-center'>
      <div className={`w-[250px] h-[300px] hover:w-[500px] rounded-[3px] overflow-hidden transition-all duration-300 ease-in-out`}
      ...
      <div className='h-full flex-1 flex flex-col gap-10 text-primary-0'>
          ...
          {SocialLinks.map((item, index) => {
            ...
            return IconComponent ? (
              <a key={index} href={item.link} target='_blank' rel='noopener noreferrer'>
                <IconComponent className={`${styles.social_icons} hover:text-grey-4`} />
              </a>
            ) : null;
          })}
        </div>
